...
class StandardGpuResources(object):
    r"""Opaque holder for Metal resources."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    impl = property(_swigfaiss.StandardGpuResources_impl_get, _swigfaiss.StandardGpuResources_impl_set)
...
def index_cpu_to_gpu(res, device, index):
    r"""Clone CPU index to Metal GPU. Caller owns returned index."""
    return _swigfaiss.index_cpu_to_gpu(res, device, index)

def index_gpu_to_cpu(index):
    r"""Copy Metal index back to CPU. Caller owns returned index."""
    return _swigfaiss.index_gpu_to_cpu(index)
...
class OnDiskInvertedLists(InvertedLists):
    ...
    def prefetch_lists(self, list_nos, nlist_in):
        return _swigfaiss.OnDiskInvertedLists_prefetch_lists(self, list_nos, nlist_in)
